              ...
              <div className="bg-gray-100 dark:bg-[#232323] rounded-lg p-8 dark:text-white">
                ...
                <div className="mb-6">
                  <div className="flex items-center mb-4">
                    ...
                    <a href="tel:+96181708706" className="block text-[12px] sm:text-[16px] md:text-[18px] font-medium break-all hover:text-[#E93323]">+961 81 708 706</a>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <a href="mailto:BechaalanyConnect@gmail.com" className="block text-[12px] sm:text-[16px] md:text-[18px] font-medium break-all hover:text-[#E93323]">BechaalanyConnect@gmail.com</a>
                  </div>
                </div>
